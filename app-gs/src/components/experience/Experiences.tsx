...
const Experiences: React.FC = () => {
  ...
  return (
    <div className="bg-[#C7B8A6] pt-20 flex flex-col md:flex-row px-4 md:px-8">
      {/* Left Half: Image, hidden on small screens */}
      <div className="w-full md:w-1/2 flex justify-center items-center md:mt-[-100px] hidden md:flex"> {/* Show only on medium screens and above */}
